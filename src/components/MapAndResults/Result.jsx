...
export default function Result() {
  ...
  useEffect(() => {
    if (mapResult.summary && mapResult.summary.length > 0) {
      setData([...mapResult.summary.sort((a, b) => b.seatCount - a.seatCount)]);
    }
  ...
  return (
    <>
      {isFetchingGeojson ? (
        ...
        <div className="  py-1 min-w-[250px] max-w-fit   ">
          <h5 className="  text-right  sm:text-right text-gray-500 font-bold">
                    ...
                    item.party !== "OTHERS" && (
                      ...
                      >
                        ...
                        <span className="flex items-center gap-2 ml-1">
                          ...
                          <span className="font-[600] text-[12px] sm:text-sm text-black">
                            {item.party}
                          </span>
                        </span>
                        ...
                        <span
                          className={clsx(
                            "text-[12px] sm:text-sm px-[10px] py-1 sm:px-8 sm:py-[6px] font-semibold flex justify-center items-center rounded-2xl  min-w-[80px] max-w-[80px] sm:min-w-[120px] sm:max-w-[120px] ml-2 sm:ml-4 text-white "
                          )}
                          style={{
                    ...
                    item.party !== "OTHERS" && (
                      ...
                      >
                        ...
                        {item.revisedVoteShare - item.voteShare >= 0 ? (
                          <span className="flex text-[12px] sm:text-sm">
                            <svg
                              fill="green"
                            ...
                            {(item.revisedVoteShare - item.voteShare)?.toFixed(
                              0
                            )}
                            %
                          </span>
                        ...
                        <span
                          className={clsx(
                            "px-[10px] py-[2px] ml-2 min-w-[150px] max-w-[150px] sm:px-4 sm:py-[3px] font-semibold flex justify-center items-center rounded-2xl sm:min-w-[170px] sm:max-w-[170px] text-[12px] sm:text-sm sm:ml-4 text-white "
                          )}
                          style={{
                            backgroundColor: PARTY_ALLIANCE_COLORS[item.party],
                            textShadow: "0px 0px 1px black",

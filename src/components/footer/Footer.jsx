        ...
        <div class="grid grid-cols-1 gap-4 md:gap-8 lg:grid-cols-3">
          <div class="flex flex-col items-center sm:items-start">
            <div class="text-teal-600">
              <img
                src="https://dhruvresearch.com/dhruv_logo.webp"
                alt="logo"
                class="h-8"
              />
            </div>

            <p class="mt-4 max-w-xs text-center text-slate-700 sm:text-start">
              A237 2nd floor, JMD megapolis, Sector 48 Sohna road, Gurgaon,
              Haryana -122018
            </p>
            ...
            <ul class="mt-8 flex gap-3 sm:gap-6">
              <li class="cursor-pointer transition hover:rotate-12">
                <a
                  href="https://www.facebook.com/DhruvResearch"
                  rel="noreferrer"
                  target="_blank"
                  class="text-slate-700 transition"
                >
                  <svg
                    c
              ...
              <li class="cursor-pointer transition hover:rotate-12">
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  class="text-slate-700 transition hover:rotate-3"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 50 50"
          ...
          <div class="grid grid-cols-1 gap-4 md:gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3">
            <div class="hidden md:flex flex-col items-center sm:items-start ">
              ...
              <ul class="mt-2 flex flex-col items-center space-y-2 text-sm sm:items-start">
                <li>
                  <a
                    href="https://dhruvresearch.com/contact.html#_solution"
                    class="text-slate-700 transition hover:underline hover:text-[#2d9cdb]"
                  >
                    {" "}
                    Market Research and Multimodal Survey{" "}
                  </a>
                </li>
            ...
            <div class="flex flex-col items-center sm:items-start">
              ...
              <ul class="mt-2 flex flex-col items-center space-y-2 text-sm sm:items-start">
                <li>
                  <a
                    href="https://dhruvresearch.com/index.html#about"
                    class="text-slate-700 transition hover:underline hover:text-[#2d9cdb]"
                  >
                    {" "}
                    About{" "}
                ...
                <li>
                  <a
                    href="https://dhruvresearch.com/index.html#what"
                    class="text-slate-700 transition hover:underline hover:text-[#2d9cdb]"
                  >
                    {" "}
                    What We Do{" "}
                ...
                <li>
                  <a
                    href="https://dhruvresearch.com/index.html#our-client"
                    class="text-slate-700 transition hover:underline hover:text-[#2d9cdb]"
                  >
                    {" "}
                    Our Clients{" "}
                ...
                <li>
                  <a
                    href="https://dhruvresearch.com/index.html#join_our_panel"
                    class="text-slate-700 transition hover:underline hover:text-[#2d9cdb]"
                  >
                    {" "}
                ...
                <li>
                  <a
                    href="https://dhruvresearch.com/index.html#our-team"
                    class="text-slate-700 transition hover:underline hover:text-[#2d9cdb]"
                  >
                ...
                <li>
                  <a
                    href="https://dhruvresearch.com/contact.html"
                    class="text-slate-700 transition hover:underline hover:text-[#2d9cdb]"
                  >
                    Contact Us
                  </a>
            ...
            <div class="flex flex-col items-center sm:items-start">
              ...
              <ul class="mt-2 flex flex-col items-center space-y-2 text-sm sm:items-start">
                <li>
                  <a
                    href="https://dhruvresearch.com/privacy.html"
                    class="text-slate-700 transition hover:underline hover:text-[#2d9cdb]"
                  >
                    {" "}
                    Privacy Policy{" "}
                ...
                <li>
                  <a
                    href="https://dhruvresearch.com/icps.html"
                    class="text-slate-700 transition hover:underline hover:text-[#2d9cdb]"
                  >
                    {" "}

          ...
          <tr style={{ backgroundColor: "#d1d5db" }}>
            ...
            {currTotalData?.year?.map((year: string, index: number) => (
              ...
              >
                ...
                <span className="absolute top-0 bottom-0 right-1 md:right-2 flex flex-col justify-center">
                  {/* decrease 3,2,1 */}
                  ...
                  <svg
                    ...
                    className={clsx(
                      "w-5 h-5 md:w-6 md:h-6  fill-red-400 cursor-pointer hover:fill-red-500",
                      {
                  ...
                  <svg
                    ...
                    className={clsx(
                      "w-5 h-5 md:w-6 md:h-6 -mt-2 fill-green-400 cursor-pointer hover:fill-green-600  ",
                      {

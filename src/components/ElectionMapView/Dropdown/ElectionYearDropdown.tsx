...
export default function ElectionYearDropdown() {
  ...
  useEffect(() => {
    ...
    const url = `https://dhruvresearch.com/api/v2/result/year?election_type=${
  ...
  useEffect(() => {
    ...
    if (select_state !== "Select State") {
      ...
      const url = `https://dhruvresearch.com/api/v2/result/year?state=${urlEncodeStateName}&election_type=${
        select_sabha === "Vidhan Sabha" ? "VS" : "LS"
      }`;
      fetchYears(url);
    } else {
      ...
      {showElectionYearDropDown && (
        ...
        >
          ...
          >
            <li
              className={clsx(
                "py-2.5 pb-1  px-3 hover:text-black hover:bg-[#ffc400] select-option rounded-tl-lg cursor-pointer",
                {
          ...
          >
            <div className="pb-1 flex items-center gap-2 text-sm">
              ...
              <div
                ...
                className="border-2 py-1 pl-2 pr-1 text-black font-[500] rounded-md flex gap-1 items-center cursor-pointer"
              >
                {/* <span>2018</span> */}
                  ...
                  (year: number, index: number) =>
                    currentSelectedYear !== year && (
                      <li
                        ...
                        className={clsx(
                          " pt-2 hover:text-[yellow] hover:font-bold  flex gap-3 items-center text-sm font-semibold cursor-pointer",
                          {

import FilterAndMapResult from "@/components/FilterAndMapResult";

export default function Home() {
  return (
    <>
      <main
        id="past-election-analysis"
        className="px-0 sm:px-10 py-5 pt-4 lg:h-[calc(100vh-80px)]  lg:min-h-[550px]  mb-5 "
      >

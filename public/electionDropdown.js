  ...
  <div class="footer-container">
    <div class="footer-top">
      <div class="footer-item-left">
        <div >
          <img src="https://dhruvresearch.com/dhruv_logo.webp" alt="logo" class="footer-logo" />
        </div>
        ...
        <ul class="footer-social-media">
          <li class="footer-social-items">
            <a href="https://www.facebook.com/DhruvResearch" rel="noreferrer" target="_blank" class="text-slate-700 transition">
              <svg c xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="35px" height="35px">
          ...
          <li class="footer-social-items">
            <a href="https://twitter.com/dhruvresearch" rel="noreferrer" target="_blank" class="text-slate-700 transition hover:rotate-3">
          ...
          <li class="footer-social-items">
            <a href="https://www.linkedin.com/company/dhruvaresearch/?viewAsMember=true" rel="noreferrer" target="_blank" class="text-slate-700 transition">
          ...
          <li class="footer-social-items">
            <a href="https://www.youtube.com/@dhruvresearch" rel="noreferrer" target="_blank" class="text-slate-700 transition">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="35px" height="35px">
          ...
          <li class="footer-social-items">
            <a href="https://instagram.com/dhruvresearch" rel="noreferrer" target="_blank" class="text-slate-700 transition">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="35px" height="35px">
                ...
                <g><circle cx="24" cy="24" r="6" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" /></g>
              </svg>
            </a>
          </li>
        </ul>
      ...
      <div class="footer-item-right">
        ...
        <div class="footer-category">
          ...
          <ul class="footer-category-list">
            <li>
              <a href="https://dhruvresearch.com/index.html#about" class="footer-category-a"> About </a>
            </li>

            <li>
              <a href="https://dhruvresearch.com/index.html#what" class="footer-category-a"> What We Do </a>
            </li>

            <li>
              <a href="https://dhruvresearch.com/index.html#our-client" class="footer-category-a"> Our Clients </a>
            </li>
            <li>
              <a href="https://dhruvresearch.com/index.html#join_our_panel" class="footer-category-a"> Join Our Survey Panel </a>
            </li>

            <li>
              <a href="https://dhruvresearch.com/index.html#our-team" class="footer-category-a">What our team has to say </a>
            </li>
            <li>
              <a href="https://dhruvresearch.com/contact.html" class="footer-category-a">Contact Us</a>
            </li>
          </ul>
        </div>

        <div class="footer-category">
          <p class="footer-category-p">Legal</p>

          <ul class="footer-category-list">
            <li>
              <a href="https://dhruvresearch.com/privacy.html" class="footer-category-a"> Privacy Policy </a>
            </li>
